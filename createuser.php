...
<?php
    ...
    if($result){
               echo "<script> alert('Hurray! Registered successfully!');
    ...
    <div class="screen">
      ...
      <div class="screen-body">
        ...
        <div class="screen-body-item">
          ...
          <!-- <a class="nav-link" href="login.php" style="color : #C0392B;"><b>LOGIN -->
                <!-- <input class="app-form-button" type="reset" value="LOGIN" name="reset"></input> -->
              <!-- </b></a> -->
        </div>
      </div>
    </div>
